...
console.log(texto.match(/(\w.[Á-ú]|[A-z])+@\w+\.\w{2,4}\.?\w{0,2}/g)) // sem contar com caracteres especiais (acentuação)

// no futuro...

console.log(texto.match(/(\w.[Á-ú]|[A-z])+@\w.+\.\w{2,4}(\.\w{2})?/g)) // Forma de grupo para deixar mais organizado!